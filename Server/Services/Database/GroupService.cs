...
namespace Server.Services.Database
{
    ...
    internal class GroupService : IGroupService
    {
        ...
        public GroupService(ChatContext db) => this.db = db;
        ...
        public async Task<Prop> CreateGroupAsync(int uid, string groupName)
        {
            ...
            throw new InfoException("Không tìm thấy người dùng!");
        }
        ...
        public async Task<Prop> AddUserToGroupAsync(int uid, string groupName)
        {
            ...
            if (group == null) throw new InfoException("Không tìm thấy nhóm!");
            if (user == null) throw new InfoException("Không tìm thấy người dùng!");
