...
namespace Client
{
    ...
    public partial class UserPage : Page
    {
        ...
        {
            string downloadFolder = string.Format("{0}\\Downloads\\DemoChat", Environment.GetFolderPath(Environment.SpecialFolder.UserProfile));
